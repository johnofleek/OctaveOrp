    ...
    def __init__(self, version='XModem'):
        try:
            ...
            if not len(self.crc_ccitt_tab):
                self.init_crc_ccitt()
            # print("INIT CRCCCITT table " , self.crc_ccitt_tab)
        except Exception as e:
            print("EXCEPTION(CRCCCITT INIT): {}".format(e))

...
#define ORP_PROTOCOL_TX_BUFFER_LENGTH 256
...
{
  orpInput_struct_temperature.keyString = (char *)"temperature/json";
  ...
  orp_input_sendJson(orpInput_struct_temperature, (char*)"\"jsonKey\":\"26.8\"");
  TRACE(("\n\r"));
  ...
  uint8_t rxBytes[] = { 0x7E,0x63,0x40,0x30,0x31,0x54,0x31,0x35,0x38,0x35,0x39,0x32,0x37,0x37,0x31,0x33,0x2E,0x38,0x34,0x33,0x36,0x36,0x30,0x2C,0x50,0x76,0x61,0x6C,0x2F,0x6F,0x64,0x2F,0x76,0x61,0x6C,0x75,0x65,0x2C,0x44,0x34,0x35,0x36,0x2E,0x30,0x30,0x30,0x30,0x30,0x30,0x53,0x65,0x7E, 0};
  uint8_t ctr = 0;
